...
export const createLanguage = async (language, language_code) => {
  ...
  export const fetchLanguages = async () => {
    try {
      const response = await fetch('/api/languages/read.php');
      const data = await response.json();
      return data;
    } catch (error) {
  ...
  export const fetchSingleLanguage = async (id) => {
    try {
      const response = await fetch(`/api/languages/read_single.php?id=${id}`);
      const data = await response.json();
      return data;
    } catch (error) {
  ...
  export const deleteLanguage = async (id) => {
    try {
      const response = await fetch('/api/languages/delete.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
